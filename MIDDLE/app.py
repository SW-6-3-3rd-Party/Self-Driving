"""MIDDLE camera, side ultrasonic, UDP, and web preview service."""
...
<title>MIDDLE Perception TX Monitor</title>
<style>
...
<body>
<header><h1>MIDDLE Perception TX Monitor</h1><div id='status'></div></header>
<main>
...
def parse_args():
    parser = argparse.ArgumentParser(description="MIDDLE perception ECU")
    ...
    parser.add_argument("--udp-host", default=None, help="HPVC HPVC IP")
...
def main():
    ...
    print(f"Web preview: http://<middle-ip>:{args.web_port}")
    stopping = False
    ...
    def stop(_signum=None, _frame=None):
        ...
        stopping = True
        print("Stopping MIDDLE perception service...", flush=True)
