"""Console receiver for checking MIDDLE UDP packets before Simulink wiring."""
...
def main():
    parser = argparse.ArgumentParser(description="Inspect MIDDLE perception UDP packets")
