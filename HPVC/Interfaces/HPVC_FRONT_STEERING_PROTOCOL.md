# HPVC -> Front TC375 Steering UDP Contract v1

This file is the frozen wire contract. Protocol changes require a new version.

## Transport

- UDP unicast: HPVC Ethernet `192.168.10.1` source port `5101` to
...
| 12 | `uint64` | Timestamp | HPVC monotonic microseconds |
...
- Bit 2, `UpstreamControlValid`: MIDDLE link and perception are currently valid.
