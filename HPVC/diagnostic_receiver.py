"""Receive and print HPVC diagnostic UDP packets."""
...
def decode_packet(data: bytes) -> dict[str, object]:
    ...
    return {
        ...
        "hpvc_time_s": struct.unpack_from("<d", data, 24)[0],
    }
...
def main() -> None:
    ...
    print(f"Listening for HPVC diagnostics on {args.host}:{args.port}")
    ...
    while True:
        try:
            ...
            raise SystemExit("Timed out waiting for HPVC diagnostics")
        try:
