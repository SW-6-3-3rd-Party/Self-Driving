function packet = tc375EncodeSteeringPacket(sequence, timestampUs, ...
    steeringAngleRad, maxSteeringRateRadS, controlMode, flags, aliveCount)
%TC375ENCODESTEERINGPACKET Encode the fixed 40-byte steering command packet.
%#codegen

packet = zeros(40, 1, 'uint8');
packet(1:4) = uint8([82; 49; 83; 67]); % R1SC
packet(5) = uint8(1);
